...
async def shutdown_event(app: FastAPI):
    ...
    # Close Google Home service
    from pc_client.services.google_home import _google_home_service

    if _google_home_service is not None:
        try:
            if _google_home_service._http_client:
                await _google_home_service.close()
        except Exception as exc:
