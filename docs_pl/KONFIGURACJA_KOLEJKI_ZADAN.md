# Przewodnik Konfiguracji Kolejki Zadań
...
## Konfiguracja Kolejki Priorytetowej

### Redis Implementation

Kolejki priorytetowe są implementowane jako osobne listy:
...
| Priorytet | Kategoria | Przykłady | Timeout |
|-----------|-----------|-----------|---------|
| 1-2 | Krytyczne | Unikanie przeszkód | 50ms |
| 3-4 | Wysokie | Sterowanie | 200ms |
| 5-6 | Normalne | ASR/TTS | 1s |
| 7-8 | Niskie | Generowanie tekstu | 5s |
| 9-10 | Tło | Logowanie | 30s |
